...
def train_on_device(obj_names, args):
    ...
    for obj_name in obj_names:
        ...
        dataset = MVTecDRAEMTrainDataset(args.data_path + obj_name + "/train/good/", args.anomaly_source_path, resize_shape=[128, 128])
        ...
        for epoch in range(args.epochs):
            ...
            scheduler.step()
            print(f'loss: {np.round(loss.item(), 4)} (l2: {np.round(l2_loss.item(), 4)}, ssim: {np.round(ssim_loss.item(), 4)}, seg: {np.round(segment_loss.item(), 4)})')
...
if __name__=="__main__":
    ...
    obj_batch = [['02_sim1'], ['02_sim2'], ['02_sim3'], ['BTAD3_sys'], ['wood_mix'], ['02_sim_contam_level_0.05'], ['02_sim_contam_level_0.08'], ['02_sim_contam_level_0.1']]
    ...
    if int(args.obj_id) == -1:
        ...
        obj_list = ['02_sim_contam_level_0.08', '02_sim_contam_level_0.1']
